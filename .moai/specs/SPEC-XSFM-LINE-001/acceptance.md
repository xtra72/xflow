...
> 버전: 0.2.0 (spec.md 정합). HISTORY: 0.2.0 — OQ-1~4 확정(RD-4~7) 반영으로 구 OQ-의존 시나리오를 확정 시나리오로 전환/추가 — AC-1.8(ErrLineInUse), AC-1.9/1.10, AC-3.3(포맷 거부), AC-5.4/5.6/5.7(빈-라인 3-세그먼트·후지정 재계산·sticky 보존), AC-6.2/6.2a/6.2b(slugify 마이그레이션·충돌).
