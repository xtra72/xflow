...
- [A-09] 디바이스 상태 속성명은 NASA/LGCP와 통일한다 (`power`, `current_temp`, `mode`, `fan_speed`). 설정온도(`target_temp`)는 STATUS 패킷에 없음.
...
```
[IDU_ADDR][CMD][SUB_CMD][DEV_TYPE][...][FAN][SLOT_NUM][OP_MODE][STATUS]...[ROOM_TEMP][INLET][OUTLET]...
