...
// TestMQTTRegistry_TotalBuiltins 는 빌트인 노드 타입이 48개인지 확인한다.
//
// 추가 항목: chart-emitter + century_hvacr01_status / century_hvacr01_control / century_hvacr01 (3종, raw-frame 통합됨)
