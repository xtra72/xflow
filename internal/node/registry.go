...
func (r *Registry) registerBuiltins() {
	builtins := []struct {
		...
		{"lg_hvacr01_status", NewHvacr01StatusNode, "io", "LG HVACR-01 (LG ICP-01) 디바이스 상태 조회"},
		{"lg_hvacr01_control", NewHvacr01ControlNode, "io", "LG HVACR-01 (LG ICP-01) 디바이스 제어 (미지원)"},
		{"lg_hvacr01", NewHvacr01Node, "io", "LG HVACR-01 (LG ICP-01) 상태 조회 + 제어 통합"},
