...
// 11개의 빌트인 노드 타입(filter, transform, switch, bridge, script, catch,
// aggregate, mapping, debug, status, deadletter)을 자동 등록한다.
...
// WithoutBuiltins 옵션이 없으면 11개의 빌트인 노드 타입이 자동 등록된다.
