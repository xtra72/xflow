...
// aggregate, mapping, output, deadletter, samsung-hvacr01-status, samsung-hvacr01-control, samsung-hvacr01,
...
func (r *Registry) registerBuiltins() {
	builtins := []struct {
		...
		{"sysmetrics-in", NewSysMetricsInNode, "io", "시스템 리소스 수신 (CPU·메모리·스토리지·디스크 I/O·네트워크, 표본 1개당 메시지 1개)"},
