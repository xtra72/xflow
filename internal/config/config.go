...
func (c *viperConfig) Storage() StorageConfig {
	...
	return StorageConfig{
		...
		ScheduleLogType: c.v.GetString("storage.schedule_log.type"),
	}
}
...
func (c *viperConfig) RemoteManagement() RemoteManagementConfig {
	...
	return RemoteManagementConfig{
		...
		ReconnectInitial:  c.v.GetDuration("remote_management.reconnect_initial"),
		ReconnectMax:      c.v.GetDuration("remote_management.reconnect_max"),
