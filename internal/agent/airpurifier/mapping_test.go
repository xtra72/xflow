...
func TestRenderTopic(t *testing.T) {
	...
	assert.Equal(t, "airpurifier/ap-101/state", renderTopic("airpurifier/{device_id}/state", did))
...
func TestBuildSubscriptionTopic(t *testing.T) {
	...
	assert.Equal(t, "airpurifier/+/state", buildSubscriptionTopic("airpurifier/{device_id}/state"))
}
