...
// 뒤에는 셋이 구별되지 않으므로(`ROUTE_TAKES_POINTS`) 이 모듈이 하는 일은 **궤적을 그
// 점 목록으로 옮기는 것** 하나다.
//
// ## 왜 간소화가 필요한가
//
 ...
 *
 * `free` 만 참이고 그것이 이 표의 전부다. `ROUTE_TAKES_POINTS` 와 묻는 것이 다르다 —
 * 저쪽은 "점을 **들 수 있는가**"(꺾은 선 · 곡선 · 자유선 셋이 참)이고 이쪽은 "끄는 동안
