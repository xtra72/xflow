...
export const NOTE_KEYS: Readonly<Record<ImportNoteReason, string>> = {
  ...
  textFontIgnored: `${EDIT}.importNoteTextFontIgnored`,
  textSizeClamped: `${EDIT}.importNoteTextSizeClamped`,
  textTemplateToken: `${EDIT}.importNoteTextTemplateToken`,
  textOrderChanged: `${EDIT}.importNoteTextOrderChanged`,
  textDropped: `${EDIT}.importNoteTextDropped`,
  textTruncated: `${EDIT}.importNoteTextTruncated`,
  tspanDropped: `${EDIT}.importNoteTspanDropped`,
