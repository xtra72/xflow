...
// - 정적 키뿐 아니라 동적 키 등 임의 엔트리에 metric_type/tags 를 부여한다.
 ...
 *
 * - `metric_type`: 생략/빈 문자열 시 백엔드가 `"unknown"` 으로 normalize 한다.
 ...
 *
 * 백엔드가 normalize 한 결과를 반환한다 (metric_type 은 항상 비어있지 않으며,
 * tags 는 항상 객체).
 *
 * @spec SPEC-STORE-003 v0.4.0
 */
