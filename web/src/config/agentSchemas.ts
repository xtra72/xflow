...
const CENTURY_HVAC_FIELDS: ConfigField[] = [
  ...
  { name: 'include_unknown_fields', type: 'boolean', label: '미분석 필드 포함 (디버깅)', default: false, description: 'register-decoded 메시지에 padding/reserved 바이트(reg03_pad_*, reg04_byte_3..6, write_byte_* 등 confirmation_status="unknown" 필드) 포함 여부. 운영=false, 프로토콜 RE/디버깅=true' },
