  ...
  'lgcnp-status': {
    ...
    configSchema: {
      fields: [
        ...
        { name: 'poll_command', type: 'select', label: '폴링 명령', options: ['get_recent', 'get_stats'], default: 'get_recent', description: 'get_recent 의 count=0 이면 drain (전체 반환 + 버퍼 비움). v0.7.1: drain 명령은 deprecated' },
