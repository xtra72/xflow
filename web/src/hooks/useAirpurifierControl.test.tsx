// useAirpurifierControl 훅 테스트 (SPEC-FACILITY-DASHBOARD-001 B1).
//
...
describe('useAirpurifierControl', () => {
  it('set_power 를 station 셀렉터 + power 로 params 에 담아 전송한다', async () => {
    ...
    const { result } = renderHook(() => useAirpurifierControl('agent-1'), { wrapper });
